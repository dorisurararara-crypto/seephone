...
### 3. K-POP 멤버 궁합 데이터 대폭 확장 (사용자 추가 mandate)

사용자 verbatim: "현재 우리 앱에 맞게 kpop 멤버들과 궁합 보는 거 인원을 훨씬 더 늘리고 싶어. 최근 5년 안에 활동한 그룹 전부 다"

현재: `celebrities.json` idol 54명 / 13 그룹 → 목표 약 **250~400 idol entry** (5~8배 확장).

빠진 그룹 (최근 5년 활동) 대표:
- 여자 4세대: TWICE / RED VELVET / MAMAMOO / (G)I-DLE / STAYC / NMIXX / KEP1ER / BABYMONSTER / ILLIT / KISS OF LIFE / fromis_9 / WEEEKLY
- 남자 4세대: Stray Kids (1→8) / TREASURE / ATEEZ / RIIZE (2→7) / BOYNEXTDOOR / ZEROBASEONE / TWS / NCT WISH / P1Harmony / The Boyz / NCT DREAM / NCT 127 / DAY6
- BTS (3→7) / SEVENTEEN (5→13) / Stray Kids (1→8) 누락 멤버 추가
- 5세대: MEOVV / IZNA / Hearts2Hearts
- 솔로: TAEYEON / Rosé / Jisoo / Jennie / Lisa / V / Jimin / Jungkook / RM / J-Hope / Jin / Suga / Sunmi / CHUNG HA / Hwasa / Solar 등

작업: data 수집 (Wikipedia/fandom cross-check) → dayPillar batch 산출 (ManseryeokService) → blurb 한/영 작성 (R82 sprint 3 어색 어휘 mandate 적용) → celebrities.json merge → 회귀 가드.
