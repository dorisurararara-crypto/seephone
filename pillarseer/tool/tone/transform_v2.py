...
def _compose_ko(ji60: str, name: str, category: str) -> str:
    ...
    # 1) Hook — 천간별 (dayMasterDeep) / element × category 5종 변주 (그 외).
    # cross-slice 반복 회피 (60× 같은 hook 문장 방지).
    if category == 'dayMasterDeep':
        hook = _GAN_HOOK.get(gan, '너는 한 분야에서 자기 색을 분명히 가진 사람이다') + '.'
    else:
        element_cat_hooks: Dict[str, Dict[str, str]] = {
            'career': {
                'wood': '너는 자기 분야를 끝까지 키워내는 단단한 사람이다.',
                'fire': '너는 사람과 결과를 동시에 만들어내는 단단한 사람이다.',
                'earth': '너는 한 자리에서 결과를 길게 쌓는 단단한 사람이다.',
                'metal': '너는 정확한 기준으로 일을 가르는 단단한 사람이다.',
                'water': '너는 분위기를 먼저 읽고 움직이는 단단한 사람이다.',
            },
            'wealth': {
                'wood': '너는 돈을 한 가지 깊은 길로 키우는 사람이다.',
                'fire': '너는 돈을 감각과 결정으로 동시에 다루는 사람이다.',
                'earth': '너는 돈을 천천히 모아 길게 쌓는 사람이다.',
                'metal': '너는 돈을 숫자로 정확히 보는 사람이다.',
                'water': '너는 돈 방향을 한 박자 먼저 읽는 사람이다.',
            },
            'love': {
                'wood': '너는 사랑할 때 한 사람을 끝까지 안고 가는 사람이다.',
                'fire': '너는 사랑할 때 마음의 방향이 빨리 정해지는 사람이다.',
                'earth': '너는 사랑할 때 천천히 깊어지는 사람이다.',
                'metal': '너는 사랑할 때 자기 기준이 분명해지는 사람이다.',
                'water': '너는 사랑할 때 상대 마음을 먼저 읽는 사람이다.',
            },
            'health': {
                'wood': '너의 몸은 잠 시간과 정확히 비례하는 사람이다.',
                'fire': '너의 몸은 감정 변화를 가장 먼저 받는 사람이다.',
                'earth': '너의 몸은 잔 신호가 천천히 누적되는 사람이다.',
                'metal': '너의 몸은 잘 안 무너지지만 한 번 무너지면 회복이 길다.',
                'water': '너의 몸은 마음 상태에 가장 빠르게 반응하는 사람이다.',
            },
            'family': {
                'wood': '너는 가족 안에서 책임을 가장 많이 지는 사람이다.',
                'fire': '너는 가족 안에서 분위기를 가장 먼저 데우는 사람이다.',
                'earth': '너는 가족 안에서 묵묵히 자리를 지키는 사람이다.',
                'metal': '너는 가족 안의 룰을 가장 분명히 지키는 사람이다.',
                'water': '너는 가족 안의 감정 변화를 가장 먼저 읽는 사람이다.',
            },
            'fame': {
                'wood': '너의 이름은 한 분야의 결과로 길게 남는 사람이다.',
                'fire': '너의 이름은 등장하는 순간 사람들 머릿속에 박히는 사람이다.',
                'earth': '너의 이름은 시간 위에서 묵직하게 자리잡는 사람이다.',
                'metal': '너의 이름은 약속을 지킨 횟수로 단단해지는 사람이다.',
                'water': '너의 이름은 깊이로 사람들에게 기억되는 사람이다.',
            },
        }
        hook = element_cat_hooks[category][element]
