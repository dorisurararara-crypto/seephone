...
void main() {
  group('Round 71 — _OracleHero ment pool (불만 #8 first-fold + #3 모순 0)', () {
    ...
    test('단정 평서 종결 ≥30 / pool 전체 (평균 1 / ment line)', () {
      // Round 77 sprint 4 — mandate: 직설 친근 해요체 ("당신은 ~다" or "~이에요").
      // 30 ment × 3 줄 = 90 줄 — 단정 평서 해요체 종결 ≥30.
      const verbs = ['이에요.', '예요.', '돼요.', '와요.', '해요.', '가요.', '봐요.',
      ...
      expect(n >= 30, isTrue,
          reason: '단정 평서 해요체 종결 $n — ≥30 필요 (30 ment 평균 1+ 줄)');
    });
