...
void main() {
  ...
  //   bucket3 = 사주살 명시 (원진살 / 도화살 / 역마살 / 천을귀인 / 공망 +
  //            R104 sprint 5c: 합/충/형 은 '합 결/충 결/형 결' 사주 jargon 대신
  //            자연어 기운/흐름 표현으로 명시 — '합의 기운' '맞물리는 기운'
  //            '부딪치는 기운' '맞서는 흐름' '무거운 약속의 기운' '깊은 다짐' 등.
  //            의미 바(모든 시나리오가 자기 사주살을 명시)는 동일하게 유지.
  ...
  const bucketSajuSal = <String>[
    '원진살', '도화살', '역마살', '천을귀인', '공망', '원진', '도화', '역마',
    // R104 sprint 5c — 합/충/형 자연어 명시 표현 (구 '합 결/충 결/형 결' 대체).
    '합의 기운', '맞물리', '포개지', '서로 맞는 흐름',
    '부딪치는 기운', '맞서는 흐름', '서로를 밀어 다듬는 기운', '부딪치며',
    '무거운 약속의 기운', '책임으로 묶인 흐름', '깊은 다짐',
  ];
