#!/usr/bin/env ruby
# Build #59 — R99 sprint 1-4: 영문 본문 자연 정제 (60일주 EN paragraph + 셀럽 blurbEn + lib hardcoded EN + l10n)
...
# 3. whatsNew — R99 사용자 verbatim mandate (영어 모드 자연화)
ko_text = <<~KO.strip
  영어 모드로 본 사용자도 더 자연스러운 표현을 만나도록 영문 본문을 전수 재작성했어요.

  60일주 평생사주 영문 풀이와 K-POP 셀럽 영문 소개 모두 반복 표현을 줄이고 사람이 쓴 글처럼 다듬었습니다. 알림과 화면 안 어색한 영어 표현도 함께 정리했어요.
KO

en_text = <<~EN.strip
  English readings now sound more natural and human.

  We rewrote all 60-pillar lifetime saju and K-pop celebrity blurbs to remove repetitive AI-like phrasing. Notification copy and in-app English have been polished alongside.
EN
