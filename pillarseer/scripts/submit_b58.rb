#!/usr/bin/env ruby
# Build #58 — R98 sprint 1-7: AI 톤 자연화 + 60일주 boilerplate 일소 + korean_josa helper
...
# 3. whatsNew — R98 사용자 verbatim mandate (자연 한국어 prose)
ko_text = <<~KO.strip
  AI가 쓴 것처럼 느껴지던 문장들을 자연스러운 한국어로 다시 다듬었어요.

  평생사주 풀이의 반복 표현을 줄이고, 60일주별 성격 문장을 더 다르게 읽히도록 손봤습니다. 조사와 어색한 표현도 함께 정리해서 전체 톤이 더 부드럽고 사람 말처럼 느껴지게 개선했어요.
KO

en_text = <<~EN.strip
  We rewrote parts that felt too AI-like into more natural Korean.

  Lifetime reading text now has less repetition, more distinct personality lines across the 60 day pillars, and smoother Korean phrasing. We also cleaned up awkward particles and wording so the overall tone feels more personal and readable.
EN
