#!/usr/bin/env ruby
# Build #74 — R109 알림 톤(어른/중·고생) 제거 + 하단 탭 전환 시 스크롤·상태 보존
...
# 3. whatsNew — R109 버그픽스
ko_text = <<~KO.strip
  - 탭을 옮겼다가 다시 돌아와도 보던 위치가 그대로 유지돼요.
  - 설정에서 더 이상 쓰지 않던 알림 톤 항목을 정리했어요.
KO

en_text = <<~EN.strip
  - Switching tabs and coming back now keeps your previous scroll position.
  - Removed an unused notification-tone setting.
EN
