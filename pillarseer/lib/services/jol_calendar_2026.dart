...
//
// ─── Provenance ─────────────────────────────────────────────────────────────
// 출처: 한국천문연구원(KASI) 2026 월력요항
//   발표일: 2025-06-30
//   보도자료: https://www.kasi.re.kr/kor/post/newsMaterial/32031
//   원자료: 우주항공청·KASI 공동 발간 「월력요항」 2026 (HWP/HWPX 첨부)
//   알고리즘: NASA/JPL DE441 천체력 기반 KST(UTC+9) 절입시각.
//
// 표 범위: 12절 (節氣 중 月支 경계가 되는 양력 12개)
//   — 입춘·경칩·청명·입하·망종·소서·입추·백로·한로·입동·대설·소한.
//   중기(中氣: 우수·춘분·곡우·소만·하지·대서·처서·추분·상강·소설·동지·대한)는 月支 변경에
//   사용하지 않으므로 본 파일에서는 제외. 24절기 전체 정보가 필요하면 SolarTermService 사용.
//
// 검증: test/new_year_2026_test.dart 에서
//   1) 12개 exact DateTime + 月支 + 月干 strict-equality
//   2) SolarTermService.jolDateTime() 천체 계산과 ±20분 sanity check
//   양쪽으로 잠금.
// ────────────────────────────────────────────────────────────────────────────
//
...
///
/// 출처: KASI 월력요항 2026 (발표일 2025-06-30, NASA DE441 천체력 기반).
/// 보도자료: https://www.kasi.re.kr/kor/post/newsMaterial/32031
