...
class _OracleHero extends StatelessWidget {
  ...
  static const _pool = <DayEnergyKind, Map<String, String>>{
    ...
    DayEnergyKind.mixedDay: {
      ...
      '庚':
          '큰 결정을 진짜 오늘 해야 하는지 한 번 더 생각해 봐요.\n작은 일 한 가지만 제대로 마무리해도 충분해요.\n끝까지 마친 그 한 건이 본인 평판으로 남아요.',
      '辛':
          '오늘은 흔들리지 않고 가는 편이 좋아요.\n익숙한 순서대로 처리하면 다음 할 일이 자연스럽게 보여요.\n그 순서대로 한 단계씩 가 봐요.',
      '壬': '오늘 키워드는 흐름 읽기예요.\n다음 할 일 한 가지만 정해 봐요.\n그 한 가지로 다음이 한결 편해져요.',
      '癸':
          '오늘은 비어 있는 자리를 채워주는 쪽이 본인이에요.\n오래 못 본 한 명한테 짧게 톡 보내 봐요.\n그 톡으로 오늘 분위기가 잡혀요.',
    },
    DayEnergyKind.actionDay: {
      ...
      '丁': '한 사람을 제대로 챙겨 봐요.\n그 사람이 본인을 쉽게 잊지 못해요.\n먼저 손 내미는 쪽이 본인이에요.',
      '戊':
          '미루던 한 가지를 오늘 진짜 끝낼 수 있는 텐션이에요.\n끝까지 한 번 가 봐요.\n그 결과는 딱 본인 이름으로 남아요.',
      '己':
          '오늘은 한 사람을 도와주기 좋은 날이에요.\n그 사람이 본인한테 고맙다고 해줘요.\n그 한마디로 본인 자리가 더 또렷해져요.',
      '庚': '오늘은 바로 정하고 가도 좋아요.\n끝까지 밀어붙인 그 한 건이 본인 평판으로 남아요.\n망설일 일이 아니에요.',
      '辛': '오늘은 남의 방식에 맞추기보다 익숙한 순서대로 처리하는 편이 좋아요.\n말끝을 분명히 정리하면 오늘 인상이 오래 남아요.\n그 자리에서 다음 일도 한결 편해져요.',
      '壬': '오늘 키워드는 새 방향이에요.\n다음 할 일이 본인한테 먼저 보여요.\n눈에 들어온 그 순서대로 가 봐요.',
      '癸': '오늘은 한 사람 기억에 오래 남는 쪽이 본인이에요.\n그 사람이 본인을 쉽게 잊지 못해요.\n그게 다음 기회로 이어져요.',
    },
  };
