...
class _OracleHero extends StatelessWidget {
  ...
  static const _pool = <DayEnergyKind, Map<String, String>>{
    DayEnergyKind.restDay: {
      '甲': '오늘은 그냥 푹 쉬는 게 맞아요.\n어제 펼친 일 한 가지만 매듭짓고 끝내 봐요.\n그 한 가지면 충분해요.',
      '乙': '한 박자 늦춰서 가도 괜찮아요.\n잠 한 시간이 단톡 다섯 개보다 훨씬 커요.\n무리한 약속은 다음으로 미뤄요.',
      '丙': '오늘은 앞에 안 나서도 돼요.\n묵은 톡 하나만 가볍게 정리해 봐요.\n그 한 가지로 마음이 가벼워져요.',
      '丁': '오늘은 조용히 가는 날이에요.\n친한 친구 한 명한테만 짧게 안부 보내 봐요.\n그 한 줄이면 충분해요.',
      '戊': '큰 결정은 오늘 굳이 안 해도 돼요.\n한 박자 미뤄도 그 일이 사라지지 않아요.\n오늘은 가만히 있는 쪽이 정답이에요.',
      '己': '남 일까지 떠맡지 말아 봐요.\n본인부터 챙길 차례예요.\n친한 한 명한테만 신경 써도 충분해요.',
      '庚': '바로 손절하려고 하지 말아 봐요.\n한 박자 더 두고 봐도 늦지 않아요.\n흔들릴 때 내린 결정은 거의 후회로 남아요.',
      '辛': '오늘은 부딪치지 않는 쪽이 좋아요.\n날을 세우면 본인이 더 다쳐요.\n어제 상한 마음부터 먼저 풀어 봐요.',
      '壬': '오늘 키워드는 멈춤이에요.\n새 방향 잡지 말고 묵은 일 한 가지만 정리해 봐요.\n그걸로 오늘은 충분해요.',
      '癸': '오늘은 끌려가지 않는 쪽이 정답이에요.\n본인 자리만 잘 지키면 돼요.\n그게 오늘의 답이에요.',
    },
    DayEnergyKind.mixedDay: {
      '甲': '큰 결정은 한 박자 미뤄요.\n작은 확인 한 가지만 끝내면 오늘 분위기가 잡혀요.\n그 한 가지가 오늘의 답이에요.',
      '乙': '한 박자 늦게 움직여 봐요.\n작은 약속 한 가지 지키면 내일이 한결 편해져요.\n그 약속이 오늘 진짜 일이에요.',
      '丙': '오늘은 한 자리만 잘 지켜요.\n친한 한 명한테 짧게 톡 한 줄 보내 봐요.\n그 한 줄이 오늘 분위기를 다 정해줘요.',
      '丁': '오늘은 한 사람한테만 집중해 봐요.\n오래된 친구한테 안부 한 줄 보내 봐요.\n다음 톡이 그 안부에서 자연스럽게 풀려요.',
      '戊': '본인 자리를 지키는 쪽으로 가 봐요.\n큰 결정은 한 박자 늦춰요.\n안 움직인 게 오늘의 답이에요.',
      '己': '오늘은 한 사람만 챙겨도 충분해요.\n묵은 약속 한 가지 끝내 봐요.\n그 약속을 끝내면 마음이 한결 가벼워져요.',
      '庚': '큰 결정을 진짜 오늘 해야 하는지 한 번 더 생각해 봐요.\n작은 일 한 가지만 제대로 마무리해도 충분해요.\n그게 본인 이미지를 만들어줘요.',
      '辛': '오늘은 흔들리지 않는 쪽이 본인이에요.\n본인 스타일만 잘 지키면 다음 할 일이 자연스럽게 보여요.\n그 결대로 가면 돼요.',
      '壬': '오늘 키워드는 흐름 읽기예요.\n다음 할 일 한 가지만 정해 봐요.\n그 한 가지로 다음이 한결 편해져요.',
      '癸': '오늘은 비어 있는 자리를 채워주는 쪽이 본인이에요.\n오래 못 본 한 명한테 짧게 톡 보내 봐요.\n그 톡으로 오늘 분위기가 잡혀요.',
    },
    DayEnergyKind.actionDay: {
      '甲': '오늘은 한 명한테 먼저 톡 보내 봐요.\n그 톡이 오늘 분위기를 다 정해줘요.\n망설이면 타이밍을 놓치기 쉬워요.',
      '乙': '미뤘던 한 가지를 진짜 오늘 끝내 봐요.\n오늘은 본인 편이에요.\n그 한 발이 내일을 결정해줘요.',
      '丙': '앞에 나서서 분위기를 잡아 봐요.\n사람들이 본인 쪽으로 자연스럽게 모여요.\n그 자리에서 다음 일도 한결 편해져요.',
      '丁': '한 사람을 제대로 챙겨 봐요.\n그 사람이 본인을 쉽게 잊지 못해요.\n먼저 손 내미는 쪽이 본인이에요.',
      '戊': '미루던 한 가지를 오늘 진짜 끝낼 수 있는 텐션이에요.\n끝까지 한 번 가 봐요.\n그 결과는 딱 본인 이름으로 남아요.',
      '己': '오늘은 한 사람을 도와주기 좋은 날이에요.\n그 사람이 본인한테 고맙다고 해줘요.\n그 한마디로 본인 자리가 더 또렷해져요.',
      '庚': '오늘은 바로 정하고 가도 좋아요.\n그 한 번이 본인 이미지를 만들어줘요.\n망설일 일이 아니에요.',
      '辛': '오늘은 본인 스타일대로 가는 쪽이 정답이에요.\n사람들이 본인을 바로 기억해요.\n그게 오늘 본인의 장점이에요.',
      '壬': '오늘 키워드는 새 방향이에요.\n다음 할 일이 본인한테 먼저 보여요.\n그 결대로 가면 돼요.',
      '癸': '오늘은 한 사람 기억에 박히는 쪽이 본인이에요.\n그 사람이 본인을 쉽게 잊지 못해요.\n그게 다음 기회로 이어져요.',
    },
  };
